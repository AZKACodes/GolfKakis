...
class BookingDetailRepositoryImpl implements BookingDetailRepository {
  ...
  Future<BookingDetailResult> onFetchBookingDetail({
    ...
    final bookingSlug = booking.bookingSlug;
    if (bookingSlug == null || bookingSlug.isEmpty) {
      throw StateError('Missing booking slug for booking detail request.');
    }
  ...
  BookingModel? _parseBooking(dynamic response) {
    ...
    return BookingModel(
      ...
      bookingSlug: _readNullableString(payload, <String>[
        'bookingSlug',
        'booking_slug',
        'slug',
      ]),

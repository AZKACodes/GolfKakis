    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            children: [
              _SlotGolfClubThumbnail(imageUrl: club?.coverPhotoUrl),
...
class _SlotGolfClubThumbnail extends StatelessWidget {
  const _SlotGolfClubThumbnail({required this.imageUrl});

...
import 'home_weather_summary.dart';
...
abstract class HomeRepository {
  ...
  Future<List<HomeQuickBookItem>> fetchQuickBookItems();
  Future<HomeWeatherSummary?> fetchCurrentWeather();
}
...
class HomeRepositoryImpl implements HomeRepository {
  ...
  @override
  Future<List<HomeQuickBookItem>> fetchQuickBookItems() async {
    try {
